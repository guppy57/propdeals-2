...
public class AssumptionSetService {
    ...
    private AssumptionSet toEntity(Long id, AssumptionSetRequest req, UUID userId,
        ...
        return new AssumptionSet(
                ...
                req.landValuePrcnt(),
                req.brokerFees(),
                req.homeInspectionSfhFee(),
                req.homeInspectionMfBaseFee(),
                req.homeInspectionMfPerUnitFee(),
                req.propertySurveyFee(),
                req.pestInspectionFee(),
                req.structuralEngineeringFee(),
                req.sewerScopeFee(),
