...
CREATE TABLE public.loans (
  ...
  pmi_amount            bigint,              -- monthly PMI if flat amount
  using_ifa_loan        boolean,             -- Iowa Finance Authority second loan
  preapproval_link      text,
...
CREATE TABLE public.neighborhood_assessment (
  id                          bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  address1                    text   NOT NULL,
  school_district_name        text   DEFAULT 'Des Moines Independent School District',
...
CREATE TABLE public.research_reports (
  ...
  research_type text         DEFAULT 'rental_comparison',
  prompt_used   text,
